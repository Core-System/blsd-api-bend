...
public class CalComService {
    ...
    public String criarAgendamento(String nome, String email, String inicio) {
        ...
        System.out.println(email);
                Cliente clienteEncontrado = clienteRepository.findByEmail(email).orElseThrow(()->new ClienteNotFoundException("Cliente não encontrado"));
                ...
                if (clienteEncontrado != null) {
                    ...
                    NotificacaoEmailRequest emailRequest = new NotificacaoEmailRequest(
                            ...
                            """
                                    <div style="background: #f5eef9; padding: 2rem; border-radius: 12px; font-family: 'Poppins', Inter, system-ui, Arial, sans-serif;">
                                              ...
                                              <div style="max-width: 560px; margin: 0 auto; background: #FFFCF9; border-radius: 12px; border: 0.5px solid #3a5b64; overflow: hidden; font-family: 'Poppins', Inter, system-ui, Arial, sans-serif;">
                                                ...
                                                <div style="padding: 2rem;">
                                                  ...
                                                  <p style="font-size: 13px; color: #1a5666; margin: 0 0 1.5rem; font-family: 'Poppins', Inter, system-ui, Arial, sans-serif;">
                                                    Olá, <strong style="color: #0B3C49  ;"></strong>
                                                  </p>
                                                  ...
                                                  <div style="background: #FDFFDA; border-radius: 8px; padding: 1.25rem; margin-bottom: 2rem;">
                                                    <p style="font-size: 14px; color: #1a5666; margin: 0 0 0.5rem; font-family: 'Poppins', Inter, system-ui, Arial, sans-serif;">
                                                      <strong style="color: #0B3C49;">Serviço:</strong> 
                                                    </p>
                                                    <p style="font-size: 14px; color: #1a5666; margin: 0 0 0.5rem; font-family: 'Poppins', Inter, system-ui, Arial, sans-serif;">
                                                      <strong style="color: #0B3C49;">Data:</strong> 
                                                    </p>
                                                    <p style="font-size: 14px; color: #1a5666; margin: 0; font-family: 'Poppins', Inter, system-ui, Arial, sans-serif;">
                                                      <strong style="color: #0B3C49;">Horário:</strong> 
                                                    </p>
                                                  </div>
                                    
                                                  <div style="text-align: center; margin: 2rem 0;">
                                                    <a href="" style="display: inline-block; background: #0B3C49; color: #FFFCF9; font-size: 14px; font-weight: 600; padding: 12px 32px; border-radius: 12px; text-decoration: none; letter-spacing: 0.01em; font-family: 'Poppins', Inter, system-ui, Arial, sans-serif;">
